  ...
  ru: {
    ...
    landing: {
      ...
      pricing: {
        ...
        sub: 'Pro — полный доступ с 7-дневным триалом. Enterprise — мониторинг и интеграции под вас.',
        ...
        ent: {
          name: 'Enterprise', badge: 'Для крупных компаний', price: 'Договорная', priceNote: 'цена по договорённости',
          lead: 'Любые проверки и интеграции — разработаем и внедрим под ваши процессы, только для вас.',
          features: ['Всё из тарифа Pro', 'Любые типы проверок под ваши системы', 'Индивидуальные интеграции (Slack, Telegram, API, webhooks)', 'Персональная разработка и внедрение', 'Выделенный менеджер и приоритетная поддержка', 'Договорные условия и SLA'],
          cta: 'Оставить заявку',
          note: 'Цена и условия обсуждаются индивидуально. Оставьте заявку — мы свяжемся с вами.',
        },
      },
      enterpriseForm: {
        title: 'Заявка на Enterprise',
        sub: 'Расскажите о задаче — какие проверки и интеграции вам нужны. Мы свяжемся и обсудим условия.',
        company: 'Компания', companyPlaceholder: 'Название компании',
        name: 'Как к вам обращаться', namePlaceholder: 'Имя',
        email: 'Email', phone: 'Телефон', phoneOptional: 'необязательно',
        message: 'Что вам нужно?', messagePlaceholder: 'Опишите задачу: что мониторим, какие интеграции, объём…',
        submit: 'Отправить заявку', sending: 'Отправка…',
        successTitle: 'Заявка отправлена', successBody: 'Спасибо! Мы свяжемся с вами по указанной почте в ближайшее время.',
        close: 'Закрыть',
    ...
    topbar: { lang: 'Язык', signout: 'Выйти', admin: 'admin', projects: 'Проекты', users: 'Пользователи', inquiries: 'Заявки', menu: 'Меню' },
    overview: {
    ...
    inquiries: {
      ...
      empty: 'Заявок пока нет', emptyHint: 'Здесь появятся обращения, отправленные через форму Enterprise на лендинге.',
      countNew: '{n} новых', statusNew: 'Новая', statusContacted: 'В работе', statusClosed: 'Закрыта',
      noCompany: 'Без компании', received: 'Получена', reply: 'Ответить письмом', remove: 'Удалить',
  ...
  pl: {
    ...
    landing: {
      ...
      pricing: {
        label: 'Cennik',
        title: 'Proste plany',
        sub: 'Pro — pełny dostęp z 7-dniowym okresem próbnym. Enterprise — monitoring i integracje pod Ciebie.',
        ...
        ent: {
          name: 'Enterprise', badge: 'Dla dużych firm', price: 'Do uzgodnienia', priceNote: 'cena ustalana indywidualnie',
          lead: 'Dowolne sprawdzenia i integracje — zaprojektujemy i wdrożymy pod Wasze procesy, tylko dla Was.',
          features: ['Wszystko z planu Pro', 'Dowolne typy sprawdzeń pod Wasze systemy', 'Indywidualne integracje (Slack, Telegram, API, webhooki)', 'Dedykowany rozwój i wdrożenie', 'Opiekun klienta i priorytetowe wsparcie', 'Warunki umowne i SLA'],
          cta: 'Zostaw zgłoszenie',
          note: 'Cena i warunki ustalane indywidualnie. Zostaw zgłoszenie — odezwiemy się.',
        },
      },
      enterpriseForm: {
        title: 'Zgłoszenie Enterprise',
        sub: 'Opowiedz o zadaniu — jakie sprawdzenia i integracje są potrzebne. Skontaktujemy się i omówimy warunki.',
        company: 'Firma', companyPlaceholder: 'Nazwa firmy',
        name: 'Jak się do Ciebie zwracać', namePlaceholder: 'Imię',
        email: 'Email', phone: 'Telefon', phoneOptional: 'opcjonalnie',
        message: 'Czego potrzebujesz?', messagePlaceholder: 'Opisz zadanie: co monitorujemy, jakie integracje, skala…',
        submit: 'Wyślij zgłoszenie', sending: 'Wysyłanie…',
        successTitle: 'Zgłoszenie wysłane', successBody: 'Dziękujemy! Odezwiemy się na podany adres w najbliższym czasie.',
        close: 'Zamknij',
    ...
    topbar: { lang: 'Język', signout: 'Wyloguj', admin: 'admin', projects: 'Projekty', users: 'Użytkownicy', inquiries: 'Zgłoszenia', menu: 'Menu' },
    overview: {
    ...
    inquiries: {
      ...
      empty: 'Brak zgłoszeń', emptyHint: 'Tu pojawią się zgłoszenia wysłane przez formularz Enterprise na landingu.',
      countNew: '{n} nowych', statusNew: 'Nowe', statusContacted: 'W toku', statusClosed: 'Zamknięte',
      noCompany: 'Bez firmy', received: 'Otrzymano', reply: 'Odpowiedz mailem', remove: 'Usuń',
  ...
  en: {
    ...
    landing: {
      ...
      pricing: {
        label: 'Pricing',
        title: 'Simple plans',
        sub: 'Pro — full access with a 7-day trial. Enterprise — monitoring and integrations built for you.',
        ...
        ent: {
          name: 'Enterprise', badge: 'For large companies', price: 'Custom', priceNote: 'negotiable pricing',
          lead: 'Any checks and integrations — designed and shipped for your processes, exclusively for you.',
          features: ['Everything in Pro', 'Any check types for your systems', 'Custom integrations (Slack, Telegram, API, webhooks)', 'Dedicated development and rollout', 'Dedicated manager and priority support', 'Contract terms and SLA'],
          cta: 'Request a quote',
          note: 'Pricing and terms are discussed individually. Leave a request — we will get back to you.',
        },
      },
      enterpriseForm: {
        title: 'Enterprise request',
        sub: 'Tell us about your task — which checks and integrations you need. We will reach out to discuss terms.',
        company: 'Company', companyPlaceholder: 'Company name',
        name: 'What should we call you', namePlaceholder: 'Name',
        email: 'Email', phone: 'Phone', phoneOptional: 'optional',
        message: 'What do you need?', messagePlaceholder: 'Describe the task: what to monitor, integrations, scale…',
        submit: 'Send request', sending: 'Sending…',
        successTitle: 'Request sent', successBody: 'Thank you! We will contact you at the provided email shortly.',
        close: 'Close',
        error: 'Could not send. Try again or email dbdcstudio@gmail.com.',
    ...
    topbar: { lang: 'Language', signout: 'Sign out', admin: 'admin', projects: 'Projects', users: 'Users', inquiries: 'Inquiries', menu: 'Menu' },
    overview: {
    ...
    inquiries: {
      ...
      sub: 'Requests from the landing Enterprise plan. Visible to moderators only.',
      empty: 'No inquiries yet', emptyHint: 'Requests sent via the Enterprise form on the landing will appear here.',
      countNew: '{n} new', statusNew: 'New', statusContacted: 'In progress', statusClosed: 'Closed',
      noCompany: 'No company', received: 'Received', reply: 'Reply by email', remove: 'Delete',
